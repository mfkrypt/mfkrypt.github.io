...
date: '2025-05-19'
tags: ['machine', 'windows', 'Active Directory', 'GenericAll', 'Shadow-Credentials', 'ESC16']
draft: false
...
Now, after being added to the group, we can perform Shadow Credentials on the 3 service accounts
