...
date: '2026-01-26'
tags: ['cyberwarfarelabs', 'cloud', 'azure', 'Command Injection']
draft: false
summary:  The challenge is a webapp that has a Command Injection vulnerability, the goal is to exploit the vulnerability by making an internal request to the Azure instance and extract the access token to authenticate then retrieve the Azure Subscription ID which is the flag 
images: /static/images/cyberwarfare/cloud/compute_crack/compute_crack.png
---
...
<div className="flex justify-center">
	<img src="/static/images/cyberwarfare/cloud/compute_crack/compute_crack2.png" alt="Description" />
</div>
