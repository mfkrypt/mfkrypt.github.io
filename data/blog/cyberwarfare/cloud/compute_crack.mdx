...
draft: false
summary:  The challenge is a webapp that has a SSRF vulnerability, the goal is to exploit the vulnerability and extract the access token to authenticate then retrieve the Subscription ID which is the flag 
---
